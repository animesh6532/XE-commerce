    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-tr from-slate-50 via-blue-50/20 to-purple-50/20">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to experience AI-powered commerce</p>
        </div>
        ...
        <div className="glass rounded-2xl shadow-xl p-8 border border-white/40 bg-white/80">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <motion.button
              ...
              className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-purple-700 focus:outline-none shadow-md shadow-blue-500/10 flex items-center justify-center gap-2 disabled:opacity-50 transition-all cursor-pointer"
            >
              {isSubmitting ? (
